...
import { twoPath, path1Points, path2Points } from "@/content/homepage";
      ...
      <div className="container mx-auto max-w-full overflow-hidden">
        <div className="text-center max-w-2xl mx-auto mb-10 sm:mb-16">
          ...
          <h2 className="heading-lg break-words">
            {twoPath.headline} <span className="text-primary">{twoPath.headlineHighlight}</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8 max-w-5xl mx-auto">
          ...
          <div className="p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-destructive/5 border border-destructive/20">
            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
              ...
              <div>
                <p className="text-xs sm:text-sm text-muted-foreground">{twoPath.path1Label}</p>
                <h3 className="text-lg sm:text-xl font-bold">{twoPath.path1Title}</h3>
              </div>
            </div>
          ...
          <div className="p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-primary/10 border border-primary/50 relative overflow-hidden">
            ...
            <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
              ...
              <div>
                <p className="text-xs sm:text-sm text-muted-foreground">{twoPath.path2Label}</p>
                <h3 className="text-lg sm:text-xl font-bold">{twoPath.path2Title}</h3>
              </div>
            </div>
            <ul className="space-y-3 sm:space-y-4">
