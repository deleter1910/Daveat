        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="p-8 rounded-2xl bg-destructive/5 border border-destructive/20">
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Weg 1</p>
                <h3 className="text-xl font-bold">Mach weiter wie bisher</h3>
              </div>
            </div>
            <ul className="space-y-4">
              {path1Points.map((point, i) => (
                <li key={i} className="flex items-start gap-3">
                  <ChevronRight className="text-destructive/60 flex-shrink-0 mt-0.5" size={18} />
          ...
          <div className="p-8 rounded-2xl bg-primary/10 border border-primary/50 relative overflow-hidden">
            ...
            <div className="flex items-center gap-4 mb-6">
              ...
              <div>
                <p className="text-sm text-muted-foreground">Weg 2</p>
                <h3 className="text-xl font-bold">Baue deine eigene Strategie</h3>
              </div>
            </div>
            <ul className="space-y-4">
